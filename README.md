...
2. 왼쪽 **프로젝트**에서 폴더를 고릅니다. `+`로 다른 폴더를 열 수 있고, 대화 상자에 **실행한 폴더 열기**가 있으면 `bun run dev`를 켠 저장소가 바로 열립니다. 새 세션은 그 폴더에서 진행됩니다.
3. 메시지를 보냅니다.
